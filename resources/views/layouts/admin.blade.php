                ...
                <div class="pcoded-wrapper">
                    <nav class="pcoded-navbar">
                        ...
                        <div class="pcoded-inner-navbar main-menu">
                            <div class="">
                                            ...
                                            <div class="main-menu-header">                                                                  
                                                ...
                                                <div class="user-details">                                                    
                                                    <span>{{ Auth::guard('admin')->user()->firstname }} {{ Auth::guard('admin')->user()->name }}</span>
                                                    <span id="more-details">{{ auth('admin')->user()->email }}<i class="ti-angle-down"></i></span>                                  
                                                </div>
                                            </div>            
                            ...
                            <ul class="pcoded-item pcoded-left-item">
                                ...
                                <li class="pcoded-hasmenu">
                                    ...
                                    <ul class="pcoded-submenu">
                                        <li class="{{ request()->routeIs('admin.proprietaires.index') ? 'active' : '' }}">
                                            <a href="{{route('admin.proprietaires.index')}}">
                                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                                <span class="pcoded-mtext" data-i18n="nav.basic-components.alert">proprietaire</span>
                                                <span class="pcoded-mcaret"></span>
                                            </a>
                                        </li>
                                        <li class="{{ request()->routeIs('admin.clients.index') ? 'active' : '' }}">
                                            <a href="{{route('admin.clients.index')}}">
                                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                                <span class="pcoded-mtext" data-i18n="nav.basic-components.breadcrumbs">Locataire</span>
                                                <span class="pcoded-mcaret"></span>
                                            </a>
                                        </li>                                     
                                    </ul>
                            ...
                            <ul class="pcoded-item pcoded-left-item">
                                <li class="{{ request()->routeIs('admin.reservations.index') ? 'active' : ''}}">
                            ...
                            <ul class="pcoded-item pcoded-left-item">
                                <li class="{{ request()->routeIs('admin.voitures.index') ? 'active' : ''}}">
                                    <a href="{{route('admin.voitures.index')}}">
                                        <span class="pcoded-micon"><i class="icofont icofont-car bg-c-blue"></i><b>FC</b></span>
                                        <span class="pcoded-mtext" data-i18n="nav.form-components.main">Les Voitures</span>
                                        <span class="pcoded-mcaret"></span>
                                    </a>
                                </li>                              
                            ...
                            <ul class="pcoded-item pcoded-left-item">
                                <li class="{{ request()->routeIs('admin.paiements.index') ? 'active' : ''}}">
                                    <a href="{{route('admin.paiements.index')}}">
                                        <span class="pcoded-micon"><i class="icofont icofont-credit-card bg-c-blue"></i><b>FC</b></span>
                                        <span class="pcoded-mtext" data-i18n="nav.form-components.main">Paiement</span>
                                        <span class="pcoded-mcaret"></span>
                                    </a>
                                </li>                              
